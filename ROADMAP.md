...
1. **Tooling & verification hardening**
   ...
   - Extend the Documenter pages for implementation notes, RareSkills mapping,
     and arkworks comparison as behaviour changes.
...
- Architecture map: `docs/src/architecture.md`
