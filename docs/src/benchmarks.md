...
Longer historical optimization notes live in [Benchmark Snapshots](@ref
benchmark-snapshots). This page keeps the benchmark workflow and external
reference comparisons in one place.
